...
export const API_ENDPOINTS = {
  ...
  TENANT: {
    ...
    POLICY_DELIVERY_STATUS: (tenantId: string) => buildTenantPath(tenantId, '/policy-deliveries/status'),
    NODES: (tenantId: string) => buildTenantPath(tenantId, '/nodes'),
    NODES_STATUS: (tenantId: string) => buildTenantPath(tenantId, '/nodes/status'),
